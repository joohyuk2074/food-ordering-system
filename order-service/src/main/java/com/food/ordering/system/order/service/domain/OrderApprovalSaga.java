...
public class OrderApprovalSaga implements SagaStep<RestaurantApprovalResponse> {
    ...
    public void process(RestaurantApprovalResponse restaurantApprovalResponse) {
        ...
        if (orderApprovalOutboxMessageResponse.isEmpty()) {
            log.info("An outbox message with saga id: {} s already processed!",
        ...
        OrderPaymentOutboxMessage orderPaymentOutboxMessage = getUpdatedPaymentOutboxMessage(
            restaurantApprovalResponse.getSagaId(),
            order.getOrderStatus(),
            sagaStatus
        );
    ...
    public void rollback(RestaurantApprovalResponse restaurantApprovalResponse) {
        ...
        OrderApprovalOutboxMessage updatedOrderApprovalOutboxMessage = getUpdatedApprovalOutboxMessage(
            orderApprovalOutboxMessage,
            domainEvent.getOrder().getOrderStatus(),
            sagaStatus
        );
        approvalOutboxHelper.save(updatedOrderApprovalOutboxMessage);
